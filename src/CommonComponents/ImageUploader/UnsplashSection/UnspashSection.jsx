...
import styles from "./unspashSection.module.scss";
// import AppleImage from '../../../assets/images/img/appleImage.png';
import Check from "../../../Assets/SiteEditor/images/Icons/check.png";
...
const UnspashSection = ({
 ...
 if (multiSelect) {
  ...
  return (
    <React.Fragment>
      <div className={styles.unspashSectionContainer}>
        <div className={styles.searchSection}>
          <SearchControl
            classNameWrappper={styles.tableSearchbar}
            placeholder="Search..."
            defaultValue={search}
        ...
        <div
          className={styles.unsplashImageContainer}
          onScroll={onScroll}
          ref={listInnerRef}
        >
              ...
              ? unsplashList.map((item, key) => {
                  return (
                    <React.Fragment key={key}>
                      <div
                        className={styles.unsplashList}
                        key={key}
                        onClick={() => handleSelect(item.urls.regular,item)}
                      >
                        <Image layout="responsive" width={1000} height={800} src={item.urls.regular} alt={item.alt} />
                        {imageList.find((i)=>i.src===item.urls.regular) && 
                          <div className={styles.divCheck}>
                            <Image width="18" height="18" src={Check} alt="" />
                          </div>
                        }
                      </div>
                      {/* 
        ...
        <div className={styles.unsplashBtnWrapper}>
