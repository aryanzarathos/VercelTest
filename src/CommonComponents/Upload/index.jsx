  ...
  (
    ...
    const handleFileSelect = async (files) => {
      ...
      if (files[0] === undefined) {
        ...
        let limit = 0;
        if (uploadLimit!=="noLimit"&&uploadLimit) {
        ...
        for (let i = 0; i < limit; i++) {
          ...
          } else if (validationProp === "imageAndVideo") {
            isAllowed = isImageAndVideo(newFileName);
    ...
    return (
      <React.Fragment>
        ...
        <FormError className={"center-xs"} show={uploadError} error="Invalid file format." />
        <FormError className={"center-xs"} show={sizeError} error="File size exceeds maximum limit." />
      </React.Fragment>
    );
  }
);
