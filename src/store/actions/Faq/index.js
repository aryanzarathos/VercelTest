  ...
  return (dispatch) => {
    FaqRequest.post(
      ...
      (success) => {
        ...
        dispatch(showToast("FAQ added successfully.."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    ...
    FaqRequest.get(
      ...
      (success) => {
        ...
        // dispatch(showToast("FAQ FeatureMarked updated successfully."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    ...
    FaqRequest.get(
      ...
      (success) => {
        ...
        // dispatch(showToast("FAQ Status updated successfully."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    FaqRequest.patch(
      ...
      (success) => {
        ...
        dispatch(showToast("FAQ updated successfully."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    FaqRequest.delete(
      ...
      (success) => {
        ...
        dispatch(showToast("FAQ deleted successfully.."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
