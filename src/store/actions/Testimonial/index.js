  ...
  return (dispatch) => {
    ...
    TestimonialRequest.post(
      ...
      (success) => {
        ...
        dispatch(showToast("testimonial added Successfully!"));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    TestimonialRequest.patch(
      ...
      (success) => {
        ...
        dispatch(showToast("Testimonial updated successfully."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    ...
    TestimonialRequest.post(
      ...
      (success) => {
        ...
        dispatch(showToast("Your review has been submitted. It will be published in our testimonials section shortly."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
  ...
  return (dispatch) => {
    ...
    TestimonialRequest.patch(
      ...
      (success) => {
        ...
        dispatch(showToast("Your review has been updated. It will be published in our testimonials section shortly."));
      },
      (error) => {
        dispatch(setCommonError(error.message));
      }
