...
class TestimonialRequest extends Request {
  constructor() {
    ...
    this.urlEndpoint = {
      ...
      edneedReviewforUser: super.url("/testimonials/testimonial/getEdneed?user=__USERID__&industry=__type__", "commonservices"),
      searchForUserReview: super.url("/testimonials/testimonial/getEdneed?user=__USERID__&__QUERY__=__TERM__&industry=__type__", "commonservices"),
      edneedReview: super.url("/testimonials/testimonial/getEdneed?type=__type__", "commonservices"),
      searchForEdneedReview: super.url("/testimonials/testimonial/getEdneed?__QUERY__=__TERM__&industry=__type__", "commonservices"),
      postUserReview: super.url("/testimonials/testimonial/edneed", "commonservices"),
      getAllTestimonails: super.url("/testimonials/allTestimonails/edneed", "commonservices"),
