import { Review_ActionTypes } from "../actions/reviews/ActionTypes"
...
const reviews = (state = REVIEWS_INITIAL_STATE, { type, payload, status }) => {

  switch (type) {
    case Review_ActionTypes.GET_ADMIN_REVIEW_LOADING:
      return ({
        ...state,
        getReviewsList: {
    ...
    case Review_ActionTypes.GET_ADMIN_REVIEW_LOADED:
      return ({
        ...state,
        getReviewsList: {
          ...state.getReviewsList,
    ...
    case Review_ActionTypes.GET_ADMIN_REVIEW_ERROR:
      return ({
        ...state,
        getReviewsList: {
          ...state.getReviewsList,
    ...
    case Review_ActionTypes.GET_ADMIN_REVIEW_RESET:
      return ({
        ...state,
        getReviewsList: {
          ...state.getReviewsList,
    ...
    case Review_ActionTypes.POST_ADMIN_REVIEW_LOADING:
      return ({
        ...state,
        postReviewData: {
    ...
    case Review_ActionTypes.POST_ADMIN_REVIEW_LOADED:
      return ({
        ...state,
        postReviewData: {
          ...state.postReviewData,
    ...
    case Review_ActionTypes.POST_ADMIN_REVIEW_ERROR:
      return ({
        ...state,
        postReviewData: {
          ...state.postReviewData,
    ...
    case Review_ActionTypes.POST_ADMIN_REVIEW_RESET:
      return ({
        ...state,
        postReviewData: {
          ...state.postReviewData,
    ...
    case Review_ActionTypes.GET_SINGLE_REVIEW_LOADING:
      return ({
        ...state,
        getSingleReviewData: {
    ...
    case Review_ActionTypes.GET_SINGLE_REVIEW_LOADED:
      return ({
        ...state,
        getSingleReviewData: {
          ...state.getSingleReviewData,
    ...
    case Review_ActionTypes.GET_SINGLE_REVIEW_ERROR:
      return ({
        ...state,
        getSingleReviewData: {
          ...state.getSingleReviewData,
    ...
    case Review_ActionTypes.GET_SINGLE_REVIEW_RESET:
      return ({
        ...state,
        getSingleReviewData: {
          ...state.getSingleReviewData,
    ...
    case Review_ActionTypes.PATCH_ADMIN_REVIEW_LOADING:
      return ({
        ...state,
        patchReviewData: {
    ...
    case Review_ActionTypes.PATCH_ADMIN_REVIEW_LOADED:
      return ({
        ...state,
        patchReviewData: {
          ...state.patchReviewData,
    ...
    case Review_ActionTypes.PATCH_ADMIN_REVIEW_ERROR:
      return ({
        ...state,
        patchReviewData: {
          ...state.patchReviewData,
    ...
    case Review_ActionTypes.PATCH_ADMIN_REVIEW_RESET:
      return ({
        ...state,
        patchReviewData: {
          ...state.patchReviewData,
    ...
    case Review_ActionTypes.DELETE_REVIEW_LOADING:
      return ({
        ...state,
        deleteReviewData: {
    ...
    case Review_ActionTypes.DELETE_REVIEW_LOADED:
      return ({
        ...state,
        deleteReviewData: {
          ...state.deleteReviewData,
    ...
    case Review_ActionTypes.DELETE_REVIEW_ERROR:
      return ({
        ...state,
        deleteReviewData: {
          ...state.deleteReviewData,
    ...
    case Review_ActionTypes.DELETE_REVIEW_RESET:
      return ({
        ...state,
        deleteReviewData: {
          ...state.deleteReviewData,
    ...
    case Review_ActionTypes.MULTIPLE_DELETE_REVIEW_LOADED:
    ...
    case Review_ActionTypes.READ_UNREAD_REVIEWS_SUCCESS:
      return ({
        ...state,
        readUnReadReviewData: {
    ...
    case Review_ActionTypes.REPLY_STATUS_UPDATE_SUCCESS:
      return ({
        ...state,
        patchReviewReplyData: {
    ...
    case Review_ActionTypes.POST_REVIEW_REPLY_LOADING:
      return ({
        ...state,
        postReviewReplyData: {
    ...
    case Review_ActionTypes.POST_REVIEW_REPLY_LOADED:
      return ({
        ...state,
        postReviewReplyData: {
          ...state.postReviewReplyData,
    ...
    case Review_ActionTypes.POST_REVIEW_REPLY_ERROR:
      return ({
        ...state,
        postReviewReplyData: {
          ...state.postReviewReplyData,
    ...
    case Review_ActionTypes.POST_REVIEW_REPLY_RESET:
      return ({
        ...state,
        postReviewReplyData: {
          ...state.postReviewReplyData,
    ...
    case Review_ActionTypes.DELETE_REVIEW_REPLY_LOADED:
      return ({
        ...state,
        deleteReviewReplyData: {
    ...
    case Review_ActionTypes.REVIEW_STATUS_UPDATE_SUCCESS:
      return ({
        ...state,
        patchReviewData: {
          ...state.patchReviewData,
    ...
    case Review_ActionTypes.MULTIPLE_PERMANANT_DELETE_LOADED:
    ...
    case Review_ActionTypes.MULTIPLE_RESTORE_REVIEW_LOADED:
    ...
    case Review_ActionTypes.SET_REVIEW_ID_SUCCESS:
      return {
        ...state,
        reviewId: payload,
      }

    case Review_ActionTypes.GET_PRODUCT_REVIEW_LOADING:
      return ({
        ...state,
        getProductReviewsData: {
    ...
    case Review_ActionTypes.GET_PRODUCT_REVIEW_LOADED:
      return ({
        ...state,
        getProductReviewsData: {
          ...state.getProductReviewsData,
    ...
    case Review_ActionTypes.GET_PRODUCT_REVIEW_ERROR:
      return ({
        ...state,
        getProductReviewsData: {
          ...state.getProductReviewsData,
    ...
    case Review_ActionTypes.GET_PRODUCT_REVIEW_RESET:
      return ({
        ...state,
        getProductReviewsData: {
          ...state.getProductReviewsData,
    ...
    case Review_ActionTypes.GET_BUYER_PRODUCT_RELATION:
      return ({
        ...state,
        BuyerProductReview: {
          ...state.BuyerProductReview,
          data: payload,
          loading: false,
          success: true,
          error: false
