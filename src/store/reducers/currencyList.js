import { CurrencyActionTypes } from "../actions/currency/currencyActionType";
...
const currencyListReducer = (
  ...
  switch (type) {
    ...
    case CurrencyActionTypes.DEFAULT_CURRENCY_LOADING:
      return {
        ...state,
        defaultCurrency: {
    ...
    case CurrencyActionTypes.DEFAULT_CURRENCY_SUCCESS:
      return {
        ...state,
        defaultCurrency: {
          ...state.defaultCurrency,
    ...
    case CurrencyActionTypes.DEFAULT_CURRENCY_FAIL:
      return {
        ...state,
        defaultCurrency: {
          ...state.defaultCurrency,
    ...
    case CurrencyActionTypes.DEFAULT_CURRENCY_RESET:
      return {
        ...state,
        defaultCurrency: {
          ...state.defaultCurrency,
