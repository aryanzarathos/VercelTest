  ...
  setUserLogin(loggedInUserData, subdomain) {
    ...
    if (!loggedInUserData.institute && !loggedInUserData.business) {
      UserData = {
        ...
        user_billing_address_same: loggedInUserData?.data?.BillingAddressIsSame
          ? loggedInUserData?.data?.BillingAddressIsSame
          : false,
        ...
        user_createdAt: loggedInUserData.data.createdAt,
        user_institute: "",
        user_institute_institute_name: "",
        user_institute_institute_address: "",
        user_institute_institute_subdomain: "",
        user_institute_institute_domain: "",
        user_trialAccount: "",
        user_business_type: loggedInUserData.websiteType
          ? loggedInUserData.websiteType.type
          : "null",
        user_activeRole: loggedInUserData.data.activeRole,
        user_trialExpiry: loggedInUserData.institute?.trialDateStart,
        user_trialPeriodDays: loggedInUserData.institute?.trialPeriodDays,
        ...
        template_type: loggedInUserData?.institute?.template_type
          ? loggedInUserData?.institute?.template_type
          : "dynamic",
        user_username: loggedInUserData.data.username,
        user_role_access: loggedInUserData.user_role
          ? loggedInUserData.user_role.roleaccess
          : [],
      };
    } else {
      UserData = {
        ...
        user_institute_institute_name: loggedInUserData.business.business_name,
        user_institute_institute_address:
          loggedInUserData.business.business_address,
        user_account_number: loggedInUserData.business.account_number,
        user_account_type: loggedInUserData.business.account_type,
        user_account_beneficiary_name:
          loggedInUserData.business.account_beneficiary_name,
        user_razorpay_id: loggedInUserData.business.razorpay_acount_id,
        user_account_ifsc_code: loggedInUserData.business.account_ifsc_code,
        user_sessionExit: loggedInUserData.institute.session
          ? loggedInUserData.institute.session.sessionExist
          : false,
        user_sessionFrom: loggedInUserData.institute.session
          ? loggedInUserData.institute.session.sessionFrom
          : false,
        user_sessionTo: loggedInUserData.institute.session
          ? loggedInUserData.institute.session.sessionTo
          : false,
        user_institute_institute_subdomain:
          loggedInUserData.business.business_subdomain,
        user_institute_institute_domain: loggedInUserData.business.domain
          ? loggedInUserData.business.domain
          : "",
        user_activeRole: loggedInUserData.data.activeRole,
        user_password_change: loggedInUserData.data.password_change,
        user_profile_picture: loggedInUserData.data.profile_picture,
        ...
        user_business_business_name: loggedInUserData.business.business_name,
        user_business_business_address:
          loggedInUserData.business.business_address,
        user_username: loggedInUserData.data.username,
        user_trialExpiry: loggedInUserData.business.trialDateStart,
        user_trialPeriodDays: loggedInUserData.business.trialPeriodDays,
        user_trialAccount: loggedInUserData.business.trialAccount,
        user_billing_address_same: loggedInUserData?.data?.BillingAddressIsSame
          ? loggedInUserData?.data?.BillingAddressIsSame
          : false,
        user_business_type: loggedInUserData.websiteType
        ...
        user_role_access: loggedInUserData.user_role
          ? loggedInUserData.user_role.roleaccess
          : [],
        user_business_business_shop_category: loggedInUserData.business
          ?.business_shop_category
          ? loggedInUserData.business.business_shop_category
          : [],
        user_institute_isOld: loggedInUserData.institute.isOld
          ? loggedInUserData.institute.isOld
          : false,
        template_type: loggedInUserData?.business?.template_type
          ? loggedInUserData?.business?.template_type
          : "static",
        user_dashboard_stepper: loggedInUserData.DashboardStepper
          ? loggedInUserData.DashboardStepper
          : this.stepperIndustry(loggedInUserData.websiteType.type),
        user_signup_method: loggedInUserData.data.signup_method
          ? loggedInUserData.data.signup_method
          : "Contact",
      };
    }
    if (subdomain) {
