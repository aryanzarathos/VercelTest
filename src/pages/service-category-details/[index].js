...
import { serviceCategoryDetailsfetchTemplateData } from "../../CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req,query }, context) {
    ...
    let resData = await serviceCategoryDetailsfetchTemplateData(req.headers.host, slug)
