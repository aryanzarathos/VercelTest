...
import fetchTemplateData, { BlogCategoriesfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await BlogCategoriesfetchTemplateData(req.headers.host, slug)
