...
import fetchTemplateData, { OrderDetailfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await OrderDetailfetchTemplateData(req.headers.host, req.url)
