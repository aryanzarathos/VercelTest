...
import fetchTemplateData, { BookingSelectionfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req,query }, context) {
  ...
  let resData = await BookingSelectionfetchTemplateData(req.headers.host)
