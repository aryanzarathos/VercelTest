...
import fetchTemplateData, { GuestOrderDetailfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await GuestOrderDetailfetchTemplateData(req.headers.host, req.url)
