...
import { serviceCollectionDetailsfetchTemplateData } from "../../CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req,query }, context) {
    const slug = query.index;


    let resData = await serviceCollectionDetailsfetchTemplateData(req.headers.host, slug)
