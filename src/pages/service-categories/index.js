...
import { serviceCategoriesfetchTemplateData } from "../../CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
    let resData = await serviceCategoriesfetchTemplateData(req.headers.host, req.url)
