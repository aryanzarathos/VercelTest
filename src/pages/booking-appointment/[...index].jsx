...
import fetchTemplateData, { bookingAppointmentfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await bookingAppointmentfetchTemplateData(req.headers.host, slug)
