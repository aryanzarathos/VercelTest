...
import fetchTemplateData, { servicePaymentfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await servicePaymentfetchTemplateData(req.headers.host, slug)
