...
import fetchTemplateData, { BlogCategoriesListfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req, query }, context) {
  ...
  let resData = await BlogCategoriesListfetchTemplateData(req.headers.host, "slug", { search, page })
