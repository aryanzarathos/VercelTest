...
import fetchTemplateData, { BlogDetailfetchTemplateData, BlogfetchTemplateData } from "@/CommonFunctions/fetchTemplateData";
...
export async function getServerSideProps({ req }, context) {
  ...
  let resData = await BlogfetchTemplateData(req.headers.host, req.url)
