...
const GuestOrderDetailsTheme1 = ({ children }) => {
    const style = {
    ...
    // // console.log(getGuestOrderBookingListLoading , !getGuestOrderBookingListSuccess,"getGuestOrderBookingListLoading && !getGuestOrderBookingListSuccessgetGuestOrderBookingListLoading && !getGuestOrderBookingListSuccessgetGuestOrderBookingListLoading && !getGuestOrderBookingListSuccess")
    return (
        <React.Fragment>
...
export default GuestOrderDetailsTheme1;