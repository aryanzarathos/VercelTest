...
import { CategoryFirst, ImageContainer1, MainCategoryWrapper, MainImage } from './CollectionTheme12.style';
...
const CollectionTheme12 = ({ children }) => {
    const data = children;
...
export default CollectionTheme12