...
import Image1 from "../../../Assets/SectionComponent/Images/GeneralPages/cover.png"
import { BlockTXTItem, BlogPara, BlogParaItem, BlogTxt, Buton, ButtonItem, CoverImg, HeaderText, HeadingTxt, Text, TittleText, TittleTextSecond } from './GeneralPagesTheme9.style';
...
const Banner = () => {
  return (
    <>
      ...
      <TittleText>This is a header Now you</TittleText>
      <BlockTXTItem>
        {data.map((e, index) => {
          return (
