...
import { MainContent, MainHeader, ProductWrap, OfferWrap, MainImage, MainSection, PrdoductDescription, ProductContent } from "./ProductListsTheme5.style";
...
const ProductTheme5 = ({ children }) => {
  ...
  // console.log("popUpHandle", popUpHandle)
