...
import { MainSearchBar, SearchBtn, SearchForm, SearchInput } from './fullSearch2.style';
...
const FullSearchBar2 = ({ FullSearch, style, searchStyle }) => {
