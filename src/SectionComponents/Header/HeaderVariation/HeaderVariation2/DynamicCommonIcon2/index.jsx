...
import { AllIcons, CartNumber, CartSection, IconButton, UserDetail, UserDropDown, UserDropDownList, UserListItem } from './DynamicIcon2.style';
...
const DynamicCommonIcon2 = ({ favorite, search, user, cart, style, FullSearch, IconStyle }) => {
...
export default DynamicCommonIcon2
