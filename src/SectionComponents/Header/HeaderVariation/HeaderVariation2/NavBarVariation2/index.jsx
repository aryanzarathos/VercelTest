...
import { MenuList, MenuListItem, MenuListItemInside, MenuListSubItem, Navbar } from './nav2.style'
          ...
          NavigationData && NavigationData?.data && NavigationData.data.length > 0 && NavigationData.data.slice(3).length ? (
            <>
              <MenuListItem item={style?.MenuListItem} ref={ref}>
                ...
                {
                  more && <MoreDropDown2 DropDownData={NavigationData.data.slice(3)}
