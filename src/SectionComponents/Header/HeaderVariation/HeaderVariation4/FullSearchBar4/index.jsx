...
import { MainSearchBar, SearchBtn, SearchForm, SearchInput } from './fullSearch4.style';
...
const FullSearchBar4 = ({ FullSearch, style, searchStyle }) => {
