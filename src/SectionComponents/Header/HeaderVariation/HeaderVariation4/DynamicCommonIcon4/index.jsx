...
import { AllIcons, CartNumber, CartSection, IconButton, UserDetail, UserDropDown, UserDropDownList, UserListItem } from './DynamicIcon4.style';
...
const DynamicCommonIcon4 = ({ favorite, search, user, cart, style, FullSearch, IconStyle }) => {
...
export default DynamicCommonIcon4
