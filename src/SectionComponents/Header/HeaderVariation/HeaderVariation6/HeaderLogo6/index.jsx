...
import { MainImage, MainLogo, LogoText, MainLogoContainer } from './logo6.style';
...
const HeaderLogo6 = ({ logoData }) => {
    const data = useContext(UserContext6);
    let styles = {
