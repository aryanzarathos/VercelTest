...
import { MainSearchBar, SearchBtn, SearchForm, SearchInput } from './fullSearch5.style';
...
const FullSearchBar5 = ({ FullSearch, style, searchStyle }) => {
