...
import { AllIcons, CartNumber, CartSection, IconButton, UserDetail, UserDropDown, UserDropDownList, UserListItem } from './DynamicIcon5.style';
...
const DynamicCommonIcon5 = ({ favorite, search, user, cart, style, FullSearch, IconStyle }) => {
...
export default DynamicCommonIcon5
