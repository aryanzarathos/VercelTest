...
import { MainSearchBar, SearchBtn, SearchForm, SearchInput } from './fullSearch3.style';
...
const FullSearchBar3 = ({ FullSearch, style, searchStyle }) => {
