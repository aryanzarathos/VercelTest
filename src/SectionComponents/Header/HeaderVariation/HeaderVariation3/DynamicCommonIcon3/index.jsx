...
import { AllIcons, CartNumber, CartSection, IconButton, UserDetail, UserDropDown, UserDropDownList, UserListItem } from './DynamicIcon3.style';
...
const DynamicCommonIcon3 = ({ favorite, search, user, cart, style, FullSearch, IconStyle, classname }) => {
    ...
    return (
        <AllIcons item={style.AllIcons} className={classname}>
            {/* ==== wishlist icon start ==== */}
            {
...
export default DynamicCommonIcon3
