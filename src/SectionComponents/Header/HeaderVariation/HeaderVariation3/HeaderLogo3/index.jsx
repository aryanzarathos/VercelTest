...
import { MainImage, MainLogo, LogoText, MainLogoContainer } from './logo3.style';
...
const HeaderLogo3 = ({ logoData, className }) => {
    ...
    return (
        <MainLogoContainer item={styles?.MainLogoContainer} className={className}>
            {/* <Link href={""}> */}
