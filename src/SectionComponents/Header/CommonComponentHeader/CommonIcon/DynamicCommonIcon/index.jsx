...
import { AllIcons, CartNumber, CartSection, IconButton, UserDetail, UserDropDown, UserDropDownList, UserListItem } from './DynamicIcon.style';
...
const DynamicCommonIcon = ({ favorite, search, user, cart, style, FullSearch, IconStyle, appointment }) => {
    ...
    return (
        <AllIcons item={style.AllIcons}>
            ...
            {/* ==== book appointment Icon start ===  */}
            {
                // width > 767 &&
                <>
                    {
                        appointment ?
                            <IconButton item={style.IconButton} iconColor={IconStyle} itemFav={style?.FavoriteIcon}
                                onClick={() => AppointmentRedirect()}>
                                <FavoriteIcon className="book_appointment" />
                            </IconButton> : ""
                    }
                </>

            }
            {/* ==== book appointment Icon end ===  */}

        </AllIcons>
    )
}

export default DynamicCommonIcon
