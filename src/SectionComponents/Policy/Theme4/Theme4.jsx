...
import { FaqList, FaqListItem, Faqs, FaqsDescription, FaqsHead, FaqsSection } from './PrivacyTheme4.style'
            ...
            <FaqsSection>
                <Faqs>
                    <FaqsHead>
                        ...
                        <h3>(Hereinafter referred to as “we, our and us”) is a co-educational institute recognized by the Board of Secondary Education Manipur (BOSEM) and Council of Higher Secondary Education Manipur (COHSEM), Govt. of Manipur.
                            We appreciate and acknowledge your trust and adhere to the legal benchmarks in gathering, using, and safeguarding any personal details provided by you. We are committed to protecting your privacy. This privacy policy provides you with details about the manner in which your data is collected, stored, and used by us. Hence, we suggest you to read this policy carefully and if you do not agree to the terms of the policy then please do not go ahead and accept the terms and conditions provided on our site.</h3>
                    </FaqsHead>
                    <FaqsDescription>
                        <FaqList>
                            <FaqListItem>
