...
import { AbsoluteImages, MainContent, MainImage, MainSection } from "./ErrorTheme11.style";
...
const ErrorTheme11 = () => {
  ...
  return (
    <MainSection>
      ...
      {/* ==== absolute images ===== */}
      <AbsoluteImages>
        <Image src={error_elven_one} alt="404 image" className="oneImage" />
        <Image src={error_elven_two} alt="404 image" className="twoImage" />
        <Image src={error_elven_three} alt="404 image" className="threeImage" />
        <Image src={error_elven_three} alt="404 image" className="fouthImage" />
      </AbsoluteImages>
      <MainContent>
