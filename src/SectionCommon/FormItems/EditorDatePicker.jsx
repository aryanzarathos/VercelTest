...
import EditerDateIcon from "../../Assets/SiteEditor/Icons/editerDateIcon.svg";
    ...
    .react-datepicker-popper{
        .react-datepicker{
            .react-datepicker__triangle{
                transform: translate(222px, 0px) !important;
            }
        }
    }
}
...
const EditorDatePicker = ({ HandleOnChange, value, ObjectData, label, submit, fullWidthChecked, placeholder }) => {
    ...
    return (
        <>
            <MainDatePickerWrapper ref={PickerRef} width={fullWidthChecked}>
                ...
                <MainDatePicker onClick={(e) => handleOnClick(e)}>
